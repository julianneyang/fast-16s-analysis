...
cd $output 
qiime longitudinal volatility --m-metadata-file state_subject_ordination.qza --p-state-column Day --p-individual-id-column subject_id --p-default-metric PC1 --o-visualization longvolplot.qzv
